...
<meta name="author" content="MUSA T. GANIYU" />
...
<pre class="r"><code>suppressMessages(library(knitr))
...
<pre class="r"><code>df &lt;- read.csv(&quot;C:/Users/mayowa/Documents/GitHub/MSDA-608/World_Health_2.csv&quot;, header = TRUE, sep = &quot;,&quot;, stringsAsFactors = FALSE)
kable(head(df[200:206, ]))</code></pre>
<table>
<thead>
<tr class="header">
<th></th>
...
<pre class="r"><code>lat_long &lt;- read.csv(&quot;C:/Users/mayowa/Documents/GitHub/MSDA-608/Countries_long_lat2.csv&quot;, header = TRUE, sep = &quot;,&quot;)
colnames(lat_long) &lt;- c(&quot;Country&quot;, &quot;Country_Code&quot;, &quot;Latitude&quot;, &quot;Longtitude&quot;)
kable(head(lat_long))</code></pre>
<table>
<thead>
<tr class="header">
...
df2[, 5:11] &lt;- sapply(df2[, 5:11], as.numeric)</code></pre>
<p>Merging column lonitude and Latitude together for a better coordinate to be in maps (googlevis)</p>
<pre class="r"><code>df2$Lat_Long = paste(df2$Latitude, df2$Longtitude, sep=&quot;:&quot;)</code></pre>
<blockquote>
...
<pre class="r"><code>sq &lt;- sqldf(&quot;select Lat_Long, Country_Name, YR2000, YR2010 from df2 
...
<pre class="r"><code>Show_map &lt;- gvisMap(sq, &quot;Lat_Long&quot; , &quot;Country_Name&quot;,
